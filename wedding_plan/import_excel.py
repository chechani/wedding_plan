...
SHEETS = [
    ...
    {"doctype": "WD Function", "sheet_name": "Functions", "natural_key": ["function_type", "date"],
    ...
    {"doctype": "WD Guest", "sheet_name": "Guests", "natural_key": ["household_name", "primary_phone"],
     ...
     "multiselects": {"functions_invited": ("WD Function", "function_type")}},
    ...
    {"doctype": "WD Shagun Entry", "sheet_name": "ShagunEntries", "natural_key": ["guest", "function", "received_by"],
     "links": {"guest": ("WD Guest", "household_name"), "function": ("WD Function", "function_type")}},
