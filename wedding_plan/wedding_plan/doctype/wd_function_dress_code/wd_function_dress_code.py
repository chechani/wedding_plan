...
class WDFunctionDressCode(Document):
	def validate(self):
		assert_child_belongs_to_parent(
			"WD Function", self.function, "wedding", self.wedding,
			_("Function {0} does not belong to the selected Wedding.").format(self.function),
		)
